...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230302145859_InitialIdentityServerConfigurationDbMigration')
BEGIN
...
BEGIN
    ...
    VALUES (N'20230302145859_InitialIdentityServerConfigurationDbMigration', N'7.0.3');
END;
GO
